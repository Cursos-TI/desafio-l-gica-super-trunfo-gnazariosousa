...
int main(){
 ...
 //entrada de dados da carta 1
    ...
    //Escolher os atributos para comparar as duas cartas

    int opcao1;

    printf("Escolha um atributo para a primeira comparacao\n");
    ...
    // Testar se o usuario escolheu o mesmo atributo duas vezes
